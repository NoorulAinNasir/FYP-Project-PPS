...
//   const { html, type, inp1, inp2, inp3, inp4, inp5, code, creator } = req.body;
//   console.log(creator, "sdkfkdsfkjnjfer");
...
//   //console.log(req.query.type, " 1111111");
//   //console.log(req.query.code, " 2222222");
//   console.log(req.query.creator, " 33333333333");
//   let ws;
//   let ws_type;
//   let Approved;
//   try {
//     ws = await worksheetModel.find({}, "html code type approved creator");
//   } catch (err) {
//     return res.status(500).send("Logging in failed, please try again later");
//   }

//   // Approved = ws.filter((a) => a.approved);
...
//     );
//     // Approved = ws_type.map((a) => a.approved);
//     //console.log(Approved.approved, "APPPROVED");
//     return res.status(200).send({
...
//   if (ws && req.query.creator) {
//     console.log("from creator req");
//     ws_type = ws.filter(
//       (w) => w.approved === true && w.creator === req.query.creator
//     );
//     return res.status(200).send({
//       ws: ws_type.map((w) => w.html),
//       code: ws_type.map((w) => w.code),
...
//   if (ws) {
//     console.log("blockedddd", ws);
//     ws_type = ws.filter((w) => w.approved === false);
...
//     );
//     if (approvedWS) {
//       console.log("sdfsf ", approvedWS);
//       return res.statjson({ approvedWS });
//     }
//   } catch (err) {
//     return res.status(500).send("Logging in failed, please try again later");
//   }
...
//     if (approvedWS) {
//       console.log("deleted ", approvedWS);
...
const getFile = async (req, res, next) => {
  ...
  try {
    notes = await fileModel.find({}, "name");
